...
MODULES:=$(MODULES) sprawl sprawl/cli sprawl/components sprawl/collision sprawl/ecs sprawl/input sprawl/input/event
...
PORNG_DIR:=sample_games/porng
porng: compile
	$(ENGINE_BIN) $(PORNG_DIR) 2>&1 | tee $(BIN_DIR)/$@-$(LOGFILE_NAME)
